...
class Where implements IWhere {
    ...
    public function in(string $column, $value, bool $or = false): IWhere {
        array_push($this->predicates, new In($column, $value, $or)); return $this;
    }
    
    public function between(string $column, $value, bool $or = false): IWhere {
        array_push($this->predicates, new Between($column, $value, $or)); return $this;
    }

    public function like(string $column, $value, bool $or = false): IWhere {
        array_push($this->predicates, new Like($column, $value, $or)); return $this;
    }

    public function isNull(string $column, bool $or = false): IWhere {
        array_push($this->predicates, new IsNull($column, $or)); return $this;
    }

    public function isNotNull(string $column, bool $or = false): IWhere {
        array_push($this->predicates, new NotNull($column, $or)); return $this;
    }
    
    public function nested(IWhere $where): IWhere {
